...
class EcommPageLocators():
    ...
    ADDING_POSITIONS_HEADER = (By.XPATH, f"//*[contains(@class, 'vkuiFormItem vkuiFormItem--withPadding vkuiInternalFormItem vkuiFormItem--sizeY-none vkuiInternalFormItem--sizeY-none vkuiFormItem--withTop vkuiInternalFormItem--withTop')]//span[contains(@class, 'FormItem_topText__cD8oZ')]")
    
    FEED_OR_COMUNITY_HEADER = (By.XPATH, f"//*[@data-entityid='url']//h4[contains(@class, 'vkuiTypography vkuiTypography--normalize vkuiTypography--weight-2 vkuiHeadline--sizeY-none vkuiHeadline--level-1')]")
    MARKETPLACE_HEADER = (By.XPATH, f"//*[@data-entityid='marketplace']//h4[contains(@class, 'vkuiTypography vkuiTypography--normalize vkuiTypography--weight-2 vkuiHeadline--sizeY-none vkuiHeadline--level-1')]")
    ADD_FILE_HEADER = (By.XPATH, f"//*[@data-entityid='file']//h4[contains(@class, 'vkuiTypography vkuiTypography--normalize vkuiTypography--weight-2 vkuiHeadline--sizeY-none vkuiHeadline--level-1')]")
    ...
    CREATE_CATALOG_FINISH_BUTTON = (By.XPATH, f"//button[contains(@class, 'vkuiButton vkuiButton--size-l vkuiButton--mode-primary vkuiButton--appearance-accent vkuiButton--align-center vkuiButton--sizeY-none vkuiTappable vkuiInternalTappable vkuiTappable--hasHover vkuiTappable--hasActive vkui-focus-visible')]//span[contains(@class, 'vkuiButton__content')]")
    CANCEL_CATALOG_FINISH_BUTTON = (By.XPATH, f"//button[contains(@class, 'vkuiButton vkuiButton--size-l vkuiButton--mode-secondary vkuiButton--appearance-accent vkuiButton--align-center vkuiButton--sizeY-none vkuiTappable vkuiInternalTappable vkuiTappable--hasHover vkuiTappable--hasActive vkui-focus-visible')]//span[contains(@class, 'vkuiButton__content')]")
    ...
    GOOD_EXAMPLE = (By.XPATH, f"//div[contains(@class, 'FileTemplate_formItemBlock__hrdpy')]//span[contains(@class, 'vkuiButton__content')]")
